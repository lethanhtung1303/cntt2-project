...
import {SatisfactionScore, Subject} from "../../../../../domain/lecturer";
...
export class LecturerSatisfactionScoreComponent implements OnInit {
    ...
    onSubmit() {
        ...
        console.log(this.satisfactionScoreForm.value)
        ...
        this.confirmationService.confirm({
            ...
            accept: () => {
                this.satisfactionScoreService.deleteSatisfactionScore({
                    ...
                    next: () => {
                        this.messageService.add({key: satisfactionScoreId.toString(), severity: 'error', summary: 'Đã xoá', detail: `Bạn đã xoá Điểm hài lòng: ${satisfactionScoreId}`});
                        this.router.navigate([], {
                            relativeTo: this.activatedRoute,
                            queryParams: {tab: 'satisfaction-score'},
                            queryParamsHandling: 'merge',
            ...
            reject: (type: ConfirmEventType) => {
                switch (type) {
                    case ConfirmEventType.REJECT:
                        this.messageService.add({key: satisfactionScoreId.toString(), severity: 'info', summary: 'Đã huỷ', detail: 'You have cancelled'});
                        break;
