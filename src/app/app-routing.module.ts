...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'lecturers/:id/training-process/:training-process-id/edit',
        component: EditTrainingProcessComponent,
      },
      ...
      {
        path: 'university-lecturer',
        component: UniversityLecturerListComponent,
      },
      ...
      {
        path: 'norms-lecture-hours/add',
        component: NormsLectureHoursComponent,
      },
      {
        path: 'norms-lecture-hours/:id',
        component: NormsLectureHoursComponent,
      },

      { path: 'contractual-lecturer', component: ContractualLecturerComponent },
      {
        path: 'contractual-lecturer/add',
        component: ContractualLecturerComponent,
      },
      {
        path: 'contractual-lecturer/:id',
        component: ContractualLecturerComponent,
      },
      ...
      { path: 'upload-lecture-time', component: UploadLectureTimeComponent },
  ...
  },
  {
    ...
    canActivate: [AuthGuardWithoutLogin],
  },
