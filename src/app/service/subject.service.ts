...
export class SubjectService {
  ...
  deleteSubject(subjectDeleteRequest: SubjectDeleteRequest): Observable<DeleteResponse> {
  ...
  getSubjectById(subjectId: string): Observable<SubjectResponse> {
    const queryParams: HttpParams = new HttpParams().append('subjectIds', subjectId);
    const headers: HttpHeaders = new HttpHeaders().append(
      'content-type',
      'application/json'
    );
  ...
  updateSubject(subjectUpdateRequest: SubjectUpdateRequest): Observable<UpdateResponse> {
